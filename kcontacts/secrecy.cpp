...
QString Secrecy::typeLabel(Type type)
{
    switch (type) {
    case Public:
        return QCoreApplication::translate("access is for everyone", "Public");
        break;
    case Private:
        return QCoreApplication::translate("access is by owner only", "Private");
        break;
    case Confidential:
        return QCoreApplication::translate("access is by owner and a controlled group",
                                           "Confidential");
        break;
    default:
        return QCoreApplication::translate("unknown secrecy type", "Unknown type");
        break;
    }
}
