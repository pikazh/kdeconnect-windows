...
{
    return QObject::tr("Unique Identifier");
}
...
{
    return QObject::tr("Formatted Name");
}
...
{
    return QObject::tr("Additional Names");
}
...
{
    return QObject::tr("Honorific Prefixes");
}
...
{
    return QObject::tr("Honorific Suffixes");
}
...
{
    return QObject::tr("Home Fax");
}

QString Addressee::businessFaxLabel()
{
    return QObject::tr("Business Fax");
}

QString Addressee::carPhoneLabel()
{
    return QObject::tr("Car Phone");
}
...
{
    return QObject::tr("Email Address");
}
...
{
    return QObject::tr("Geographic Position");
}
...
{
    return QCoreApplication::translate("a person's title", "Title");
}
...
{
    return QCoreApplication::translate("of a person in an organization", "Role");
}
...
{
    return QObject::tr("Organization");
}
...
{
    return QObject::tr("Product Identifier");
}
...
{
    return QObject::tr("Revision Date");
}
...
{
    return QObject::tr("Security Class");
}
