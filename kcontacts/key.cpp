...
QString Key::typeLabel(Type type)
{
    switch (type) {
    case X509:
        return QCoreApplication::translate("X.509 public key", "X509");
        break;
    case PGP:
        return QCoreApplication::translate("Pretty Good Privacy key", "PGP");
        break;
    case Custom:
        return QCoreApplication::translate("A custom key", "Custom");
        break;
    default:
        return QCoreApplication::translate("another type of encryption key", "Unknown type");
        break;
    }
}
