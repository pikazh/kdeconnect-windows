...
{
    return QObject::tr("Post Office Box");
}
...
{
    return QObject::tr("Extended Address Information");
}
...
{
    return QObject::tr("Delivery Label");
}
...
QString Address::typeFlagLabel(TypeFlag type)
{
    switch (type) {
    case Dom:
        return QObject::tr("Domestic");
    case Intl:
        return QObject::tr("International");
    case Postal:
        return QObject::tr("Postal");
    case Parcel:
        return QObject::tr("Parcel");
    case Home:
        return QObject::tr("Home");
    case Work:
        return QObject::tr("Work");
    case Pref:
        return QObject::tr("Preferred Address");
    }
