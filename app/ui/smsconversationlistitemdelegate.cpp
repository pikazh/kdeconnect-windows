...
SMSConversationListItemDelegate::SMSConversationListItemDelegate(QWidget *parent)
    : QStyledItemDelegate(parent)
{}

void SMSConversationListItemDelegate::paint(QPainter *painter,
                                            ...
                                            const QModelIndex &index) const
{
    ...
    rect.setRect(rect.x() + icon_width + 2 * icon_x_margin,
                 rect.y(),
                 remaining_width,
                 rect.height());
    ...
    { // Description painting
        auto description = index.data(Qt::ToolTipRole).toString().simplified();
