...
{
public:
    ClosureForFunc1(const Func &f, const Arg1 &arg1)
        : f_(f)
        , arg1_(arg1)
    {
...
{
public:
    ClosureForFunc2(const Func &f, const Arg1 &arg1, const Arg2 &arg2)
        : f_(f)
        , arg1_(arg1)
        , arg2_(arg2)
    {
...
{
public:
    ClosureForFunc3(const Func &f, const Arg1 &arg1, const Arg2 &arg2, const Arg3 &arg3)
        : f_(f)
        , arg1_(arg1)
        , arg2_(arg2)
        , arg3_(arg3)
...
template<typename Func>
std::shared_ptr<Closure> make_closure(const Func &f)
{
    return std::make_shared<ClosureForFunc0<Func>>(f);
}

template<typename Func, typename Arg1>
std::shared_ptr<Closure> make_closure(const Func &f, const Arg1 &arg1)
{
    return std::make_shared<ClosureForFunc1<Func, Arg1>>(f, arg1);
}

template<typename Func, typename Arg1, typename Arg2>
std::shared_ptr<Closure> make_closure(const Func &f, const Arg1 &arg1, const Arg2 &arg2)
{
